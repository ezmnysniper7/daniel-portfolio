...
export function MobileNav() {
  ...
  return (
    <motion.nav
      ...
      className="md:hidden fixed bottom-6 left-0 right-0 z-50 px-2"
      style={{ maxWidth: '100vw', width: '100vw' }}
    >
      <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg border border-gray-200 dark:border-gray-800 rounded-2xl shadow-xl px-4 py-3 mx-auto" style={{ maxWidth: '600px' }}>
